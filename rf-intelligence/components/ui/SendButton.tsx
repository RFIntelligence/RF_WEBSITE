...
/**
 * SendButton — premium animated submit button for the contact form.
 * Adapted from the styled-components reference design:
 *  - `sent` prop drives the "Sent" state (instead of :focus, which fights
 *    form submission flow).
 *  - letter animation uses the --i custom property per span.
 */
...
const LETTERS_DEFAULT = "SendMessage".split("");
const LETTERS_SENT = "Sent".split("");

export function SendButton({ sent, disabled }: SendButtonProps) {
  return (
    <StyledWrapper>
      <button
        type="submit"
      ...
      >
        ...
        <div className="state state--default">
          ...
          <p>
            {LETTERS_DEFAULT.map((letter, index) => (
